...
def subir_archivos(driver, wait, nombre, periodo_valor, tipo="ventas"):
    ...
    try:
        ...
        print(f"✔️ Archivo {tipo} subido: {archivo_path}")
    except Exception as e:
        print(f"❌ Error al subir archivo {tipo}: {e}")
    ...
    try:
        ...
        print(f"✔️ Archivo de alícuotas subido: {alicuotas_path}")
    except Exception as e:
        print(f"❌ Error al subir alícuotas de {tipo}: {e}")
    ...
    try:
        ...
        importar_btn.click()
        print("✔️ Clic en botón Importar")
    except Exception as e:
        print(f"❌ Error al hacer clic en Importar: {e}")
    ...
    try:
        ...
        print(f"⚠️ No se pudo confirmar finalización de importación: {e}")
    ...
    try:
        ...
        print("✔️ Clic en botón Cerrar del modal")
    except Exception as e:
        print(f"⚠️ No se pudo hacer clic en el botón Cerrar: {e}")
